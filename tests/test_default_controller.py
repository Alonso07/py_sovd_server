...
from sovd_server.models.cyclic_subscription_collection import (
    CyclicSubscriptionCollection,
)  # noqa: E501
from sovd_server.models.cyclic_subscription_create import (
    CyclicSubscriptionCreate,
)  # noqa: E501
from sovd_server.models.cyclic_subscription_update import (
    CyclicSubscriptionUpdate,
)  # noqa: E501
...
from sovd_server.models.data_resource_collection import (
...
from sovd_server.models.operation_execution_modify import (
    OperationExecutionModify,
)  # noqa: E501
from sovd_server.models.operation_execution_request import (
...
from sovd_server.models.script_execution_collection import (
    ScriptExecutionCollection,
)  # noqa: E501
from sovd_server.models.script_execution_request import (
...
class TestDefaultController(BaseTestCase):
    ...
    def test_create_cyclic_subscription(self):
        ...
        response = self.client.open(
            "/{entity_path}/cyclic-subscriptions".format(
                entity_path="entity_path_example"
            ),
            method="POST",
            headers=headers,
    ...
    def test_delete_cyclic_subscription(self):
        ...
        response = self.client.open(
            "/{entity_path}/cyclic-subscriptions/{subscription_id}".format(
                entity_path="entity_path_example",
    ...
    def test_delete_data_list(self):
        ...
        response = self.client.open(
            "/{entity_path}/data-lists/{data_list_id}".format(
                entity_path="entity_path_example", data_list_id="data_list_id_example"
            ),
            method="DELETE",
            headers=headers,
        )
    ...
    def test_delete_fault(self):
        ...
        response = self.client.open(
            "/{entity_path}/faults/{fault_code}".format(
                entity_path="entity_path_example", fault_code="fault_code_example"
            ),
            method="DELETE",
            headers=headers,
        )
    ...
    def test_delete_trigger(self):
        ...
        response = self.client.open(
            "/{entity_path}/triggers/{trigger_id}".format(
                entity_path="entity_path_example", trigger_id="trigger_id_example"
            ),
            method="DELETE",
            headers=headers,
        )
    ...
    def test_get_configuration(self):
        ...
        response = self.client.open(
            "/{entity_path}/configurations/{configuration_id}".format(
                entity_path="entity_path_example",
    ...
    def test_get_cyclic_subscription_events(self):
        ...
        response = self.client.open(
            "/{entity_path}/cyclic-subscriptions/{subscription_id}/events".format(
                entity_path="entity_path_example",
                subscription_id="subscription_id_example",
            ),
            method="GET",
    ...
    def test_get_data_resource(self):
        ...
        response = self.client.open(
            "/{entity_path}/data/{data_id}".format(
                entity_path="entity_path_example", data_id="data_id_example"
            ),
            method="GET",
            headers=headers,
            query_string=query_string,
    ...
    def test_get_entities(self):
        ...
        response = self.client.open(
            "/{entity_collection}".format(
                entity_collection="entity_collection_example"
            ),
            method="GET",
            headers=headers,
            query_string=query_string,
    ...
    def test_get_mode(self):
        ...
        response = self.client.open(
            "/{entity_path}/modes/{mode_id}".format(
                entity_path="entity_path_example", mode_id="mode_id_example"
            ),
            method="GET",
            headers=headers,
            query_string=query_string,
    ...
    def test_get_operation(self):
        ...
        response = self.client.open(
            "/{entity_path}/operations/{operation_id}".format(
                entity_path="entity_path_example", operation_id="operation_id_example"
            ),
            method="GET",
            headers=headers,
            query_string=query_string,
    ...
    def test_get_operation_execution_status(self):
        ...
        response = self.client.open(
            "/{entity_path}/operations/{operation_id}/executions/{execution_id}".format(
                entity_path="entity_path_example",
    ...
    def test_get_operation_executions(self):
        ...
        response = self.client.open(
            "/{entity_path}/operations/{operation_id}/executions".format(
                entity_path="entity_path_example", operation_id="operation_id_example"
            ),
            method="GET",
            headers=headers,
    ...
    def test_get_script(self):
        ...
        response = self.client.open(
            "/{entity_path}/scripts/{script_id}".format(
                entity_path="entity_path_example", script_id="script_id_example"
            ),
            method="GET",
            headers=headers,
        )
    ...
    def test_get_script_execution_status(self):
        ...
        response = self.client.open(
            "/{entity_path}/scripts/{script_id}/executions/{execution_id}".format(
                entity_path="entity_path_example",
    ...
    def test_get_script_executions(self):
        ...
        response = self.client.open(
            "/{entity_path}/scripts/{script_id}/executions".format(
                entity_path="entity_path_example", script_id="script_id_example"
            ),
            method="GET",
            headers=headers,
    ...
    def test_get_trigger_events(self):
        ...
        response = self.client.open(
            "/{entity_path}/triggers/{trigger_id}/events".format(
                entity_path="entity_path_example", trigger_id="trigger_id_example"
            ),
            method="GET",
            headers=headers,
    ...
    def test_get_version_info(self):
        ...
        response = self.client.open("/version-info", method="GET", headers=headers)
        self.assert200(response, "Response body is : " + response.data.decode("utf-8"))
