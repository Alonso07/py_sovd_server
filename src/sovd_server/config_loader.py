...
class SOVDConfigLoader:
    ...
    def load_entity_config(self, entity_type: str) -> Dict[str, Any]:
        ...
        try:
            ...
            self.logger.info(f"Loaded {entity_type} entity configuration from {config_file}")
            return config
        except FileNotFoundError:
    ...
    def load_resource_config(self, resource_type: str, resource_file: str) -> Dict[str, Any]:
        ...
        try:
            ...
            self.logger.info(f"Loaded {resource_type} resource configuration from {config_file}")
            return config
        except FileNotFoundError:
            self.logger.error(f"Resource configuration file not found: {config_file}")
            raise
        except yaml.YAMLError as e:
            self.logger.error(f"Error parsing {resource_type} resource configuration: {e}")
            raise
    ...
    def get_data_resource(self, entity_path: str, resource_id: str) -> Optional[Dict[str, Any]]:
    ...
    def get_operation(self, entity_path: str, operation_id: str) -> Optional[Dict[str, Any]]:
